...
public class UserRequest {
    ...
    public static void receive_user_requests(BufferedReader in, DataOutputStream out, ArrayList<Group> groups, ArrayList<ChatApplicationThread> clients, String from_user, ArrayList<String> generated_group_codes) throws IOException{
        String user_request = "";
        do {
            user_request = in.readLine();
            if(!user_request.equalsIgnoreCase("Exit")){
                System.out.println("Stringa ricevuta dal client: " + user_request);
                identify_request(user_request, groups, clients, in, out, from_user, generated_group_codes);
            } 
        } while (!user_request.equalsIgnoreCase("Exit"));
    }

    //Divisione della stringa
    public static void identify_request(String string_from_user, ArrayList<Group> groups, ArrayList<ChatApplicationThread> clients, BufferedReader in, DataOutputStream out, String from_user,ArrayList<String> generated_group_codes) throws IOException{
            ...
            try {
                ...
                if(isRequest(request)){
                    ...
                    request_type(request, message, groups, clients, in, out, from_user, generated_group_codes);
                } else {
    ...
    public static void request_type(String request, String messaggio ,ArrayList<Group> groups, ArrayList<ChatApplicationThread> clients, BufferedReader in, DataOutputStream out, String from_user,ArrayList<String> generated_group_codes) throws IOException{
        ...
        try {
            switch(comando){
                ...
                case '/': 
                    OtherRequests or = new OtherRequests(in, out, clients, groups, generated_group_codes);
